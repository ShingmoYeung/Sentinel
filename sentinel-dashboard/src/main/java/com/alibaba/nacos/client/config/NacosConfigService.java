...
public class NacosConfigService implements ConfigService {
     ...
     */
    @Override
    public boolean publishConfig(String dataId, String group, String dataType, String content) throws NacosException {
        return publishConfigInner(namespace, dataId, group, dataType, null, null, null, content);
    }
    ...
    /**
     * add publish rule file data type
     *
     * @param tenant
     * @param dataId
     * @param group
     ...
     * @throws NacosException
     */
    private boolean publishConfigInner(String tenant, String dataId, String group, String dataType, String tag,
                                       String appName, String betaIps, String content) throws NacosException {
        group = null2defaultGroup(group);
        ParamUtils.checkParam(dataId, group, content);
        ...
        params.add("content");
        params.add(content);
        // add rule file data type: json
        if (StringUtils.isNotEmpty(dataType) && StringUtils.equalsIgnoreCase(ConfigType.JSON.getType(), dataType)) {
            params.add("type");
            params.add(ConfigType.JSON.getType());
        }
        if (StringUtils.isNotEmpty(tenant)) {
            params.add("tenant");
            params.add(tenant);
