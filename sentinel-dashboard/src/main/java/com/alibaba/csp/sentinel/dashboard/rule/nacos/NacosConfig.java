...
public class NacosConfig {
    ...
    public ConfigService nacosConfigService(NacosProperties nacosProperties) throws Exception {
        ...
        properties.put(PropertyKeyConst.SERVER_ADDR, nacosProperties.getServerAddress());
        properties.put(PropertyKeyConst.NAMESPACE, nacosProperties.getNamespace());
        if (StringUtils.isNoneEmpty(nacosProperties.getUsername(), nacosProperties.getPassword())) {
